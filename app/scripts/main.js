...
(function(){
  angular.module('SELab', ['duScroll', 'duParallax']).controller('PageController', function($scope, $document, parallaxHelper){
    $scope.labmates = [
      {
        name: '林孝融',
        email: '123@test.com'
    ...
    return $scope.background = parallaxHelper.createAnimator(-0.3);
